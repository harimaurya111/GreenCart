    ...
    return product && (
        <div className="max-w-6xl w-full px-6 ">
                    ...
                    <div className="flex flex-col gap-3">
                        {product.image.map((image, index) => (
                            <div key={index} onClick={() => setThumbnail(image)} className="border max-w-24 border-gray-500/30 rounded overflow-hidden cursor-pointer" >
                               <img src={image} alt={`Thumbnail ${index + 1}`} className="h-full w-full"/>
                            </div>
                        ))}
                    </div>

                    <div className="border border-gray-500/30 max-w-100 w-full rounded overflow-hidden">
                        <img src={thumbnail} alt="Selected product" className="h-full w-full"/>
                    </div>
                </div>
            ...
            <div className="flex flex-col items-center mt-20">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-5 md:gap-6 mt-6 w-full">
                    {relatedProduct
